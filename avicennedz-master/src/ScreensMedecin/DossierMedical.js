...
class Dashboard extends React.Component {
    ...
    setPrescMedicamentChange = (event) => {
        const { target: { value } } = event;
        this.setState({
            prescriptionMed: typeof value === 'string' ? value.split(',') : value
        });
    }
    ...
    toggleMat = () => {
        this.setState({matin :  !this.state.matin})
    }
    toggleMid = () => {
        this.setState({midi :  !this.state.midi})
    }
    toggleSoir = () => {
        this.setState({soir :  !this.state.soir})
    }
                ...
                >
                    <Card sx={styleModal}>
                        <Grid container spacing={2} style={{ padding: 16 }}>
                            ...
                            <Grid item xs={5}></Grid>
                            <Grid item xs={4}>
                                <FormControl variant="outlined" className={classes.textField} sx={{ m: 1, minWidth: 200, borderColor: 'transparent' }}>
                                    <InputLabel id="demo-simple-select-label">Médicament</InputLabel>
                                    <Select
                                        labelId="demo-simple-select-label"
                                        id="demo-simple-select"
                                        
                                        value={this.state.prescriptionMed}
                                        label="Médicament"
                                        placeholder='Medicament'
                                        onChange={this.setPrescMedicamentChange}
                                    >
                                        <MenuItem value={10}>Paracétamol</MenuItem>
                                        <MenuItem value={20}>Doliprane</MenuItem>
                                    </Select>
                                </FormControl>
                            </Grid>
                            <Grid item xs={4}>
                                <FormControl variant="outlined" className={classes.textField} sx={{ m: 1, minWidth: 200, borderColor: 'transparent' }}>
                                    <InputLabel id="demo-simple-select-label">Prises par jour</InputLabel>
                                    <Select
                                        labelId="demo-simple-select-label"
                                        id="demo-simple-select"
                                        value={this.state.prescriptionMed}
                                        label="Prises par jour"
                                        placeholder='Medicament'
                                        onChange={this.setPrescMedicamentChange}
                                    >
                                        <MenuItem value={10}>1 fois</MenuItem>
                                        <MenuItem value={10}>2 fois</MenuItem>
                                        <MenuItem value={20}>3 fois</MenuItem>
                                        <MenuItem value={30}>4 fois</MenuItem>
                                    </Select>
                                </FormControl>
                            </Grid>
                            <Grid item xs={4}>
                                <FormControl variant="outlined" className={classes.textField} sx={{ m: 1, minWidth: 200, borderColor: 'transparent' }}>
                                    <InputLabel id="demo-simple-select-label">Dosage</InputLabel>
                                    <Select
                                        labelId="demo-simple-select-label"
                                        id="demo-simple-select"
                                        value={this.state.prescriptionMed}
                                        ...
                                        onChange={this.setPrescMedicamentChange}
                                    >
                                        <MenuItem value={10}>20mg</MenuItem>
                                        <MenuItem value={20}>50mg</MenuItem>
                                        <MenuItem value={30}>100mg</MenuItem>
                                    </Select>
                                </FormControl>
                            </Grid>
                            ...
                            <Grid item xs={6} style={{
                                ...
                                <text className={classes.subTitle}>Horaires</text>
                            </Grid>
                            <Grid item xs={6}></Grid>
                            
                            <Grid item xs={4} >
                                <Button variant="outlined" style={{ width: 200, height: 45, borderRadius: 50, backgroundColor : this.state.matin ? '#00798D' : '#FFFFFF' }} onClick={this.toggleMat} >Matin</Button>
                            </Grid>
                            <Grid item xs={4} >
                                <Button variant="outlined" style={{ width: 200, height: 45, borderRadius: 50, backgroundColor : this.state.midi ? '#00798D' : '#FFFFFF' }} onClick={this.toggleMid}>Midi</Button>
                            </Grid>
                            <Grid item xs={4} >
                                <Button variant="outlined" style={{ width: 200, height: 45, borderRadius: 50, backgroundColor : this.state.soir ? '#00798D' : '#FFFFFF' }} onClick={this.toggleSoir} >Soir</Button>
                            </Grid>
                            ...
                            <Grid item xs={6} style={{
                                ...
                                <text className={classes.subTitle}>Repas</text>
                            </Grid>
                            <Grid item xs={6}></Grid>

                            <Grid item xs={4} >
                                <Button variant="outlined" style={{ width: 200, height: 45, borderRadius: 50 }} >Avant</Button>
                            </Grid>
                            <Grid item xs={4} >
                                <Button variant="outlined" style={{ width: 200, height: 45, borderRadius: 50 }} >Pendant</Button>
                            </Grid>
                            <Grid item xs={4} >
                                <Button variant="outlined" style={{ width: 200, height: 45, borderRadius: 50 }} >Après</Button>
                            </Grid>
